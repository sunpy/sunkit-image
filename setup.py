...
if sys.version_info < tuple(
    ...
    sys.stderr.write(
        "ERROR: sunkit-image requires Python {} or later\n".format(
...
try:
    ...
    cmdclassd["test"] = type(
        "SunPyTest", (SunPyTest,), {"package_name": "sunkit-image"}
    )
...
if extra_tags:
    extras_require = {
        tag: [m.strip() for m in metadata["{tag}_requires".format(tag=tag)].split(",")]
...
setup(
    ...
    url=URL,
    project_urls={
        "Funding": "https://www.flipcause.com/widget/widget_home/MTgxMTU=",
